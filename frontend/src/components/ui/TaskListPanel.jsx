    ...
    <div className="glass-panel p-3 flex flex-col min-h-0">
      <div className="flex items-center justify-between shrink-0">
        <h3 className="panel-title">
          Tasks {tasks.length > 0 && <span className="text-slate-600 font-normal">({tasks.length})</span>}
        </h3>
        <button
      ...
      {!collapsed && (
        <div className="flex flex-col min-h-0 flex-1 mt-2 overflow-hidden">
          ...
          {tasks.length === 0 && isMediator && (
            <p className="text-[10px] text-slate-500 italic mt-2">No tasks yet. Add tasks to plan your sprint.</p>
          )}
        </div>
      )}
